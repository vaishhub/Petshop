...
<!--*********************************************Food PACKAGES************************************************-->
        ...
        <div class="col-md-3" >
            ...
            <br>
              ...
              <a href="signup.php" class="btn btn-success btn-sm pull-right wow fadeInDown">Register here to View More</a>
            </div>
            <br>
                <div class="panel panel-default wow fadeInDown">
                    ...
                    <div class="recent-work-wrap class="wow fadeInDown"">
                        <img class="img-responsive wow fadeInDown" src="images/map.jpg" alt="">
                            ...
                            <div class="recent-work-inner">
                                <a class="preview wow fadeInDown" href="images/satar.png" rel="prettyPhoto"><br><span class="btn btn-success btm-sm pull-right">Preview Map</span></a>
                            </div> 
                    </div>
                </div>  
        </div>
